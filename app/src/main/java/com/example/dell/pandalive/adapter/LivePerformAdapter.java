...
public class LivePerformAdapter extends RecyclerView.Adapter{
    private Jiekou jiekou;
    private List<LivePerformBean.VideoBean> performlist;
    private Context context;

    public LivePerformAdapter( Context context,List<LivePerformBean.VideoBean> splendidlist) {
        this.performlist = splendidlist;
...
//        ((HoldView)holder).textView.setText(s);
        ...
        Glide.with(context).load(performlist.get(position).getImg()).into(holdView.live_xrecy_adapter_img);
        holdView.live_xrecy_adapter_time.setText(performlist.get(position).getLen());
        holdView.live_xrecy_adapter_date.setText(performlist.get(position).getPtime());
        holdView.live_xrecy_adapter_name.setText(performlist.get(position).getT());
